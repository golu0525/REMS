...
public class PostProperty extends javax.swing.JFrame {

    public PostProperty(String title) {
    	super(title);
    ...
    public static void main(String args[]) {
        ...
        PostProperty pp=new PostProperty("post");
        pp.setVisible(true);
