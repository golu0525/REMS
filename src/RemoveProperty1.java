...
public class RemoveProperty1 extends javax.swing.JFrame {

    public RemoveProperty1(String title) {
       super(title);
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	if(evt.getSource()==jButton1){
            		...
            		String query="delete from customerdetail where name=? and phone=?";
					...
					try {
	            		...
	            		JOptionPane.showMessageDialog(getParent(), "Record Deleted!!!", "INFO", 1);
	            		conn.close();
	            		ps.close();
	...
	public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveProperty1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
